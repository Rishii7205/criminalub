...
IN_BTTS = [
    [
        Button.url(
            "Repository",
            url="https://github.com/rishii7205/criminalub",
        ),
        Button.url("Support", url="https://t.me/world_of_unknown"),
    ]
]
            ...
            if owner and event.sender_id not in owner_and_sudos():
                res = [
                    await event.builder.article(
                        title="Criminal Userbot",
                        url="https://t.me/FEEL_THE_POWER_OF_UR_DAD",
                        description="(c) 𝐆𝐇𝐎𝐒𝐓",
                        text=MSG,
                        thumb=InputWebDocument(
                            "https://te.legra.ph/file/b533397c594c0c2df6224.jpg",
                            0,
                            "image/jpeg",
                            [],
                        ),
                    ...
                    await event.answer(
                        [
                            await event.builder.article(
                                ...
                                text=error_text(),
                                buttons=Button.url(
                                    "Report", "https://t.me/world_of_unknown"
                                ),
                            )
                        ]
                    )
